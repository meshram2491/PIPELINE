	...
	stages {
		...
		stage('Deployment'){
		    steps {
                ...
                stage('Slack') {
                   steps {
                           slackSend baseUrl: 'https://hooks.slack.com/services/', channel: 'devops-tool', color: 'good', message: 'this is sample', notifyCommitters: true, teamDomain: 'A1', tokenCredentialId: 'e8953ad0-ffd4-4954-b7c7-5edbd342badd'
}}
}}
